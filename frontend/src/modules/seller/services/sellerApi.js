...
export const sellerApi = {
    ...
    assignDeliveryBoy: (orderId, deliveryBoyId) => axiosInstance.post(`/orders/${orderId}/assign-delivery-boy`, { deliveryBoyId }),
    broadcastDelivery: (orderId) => axiosInstance.post(`/orders/${orderId}/broadcast-delivery`),
    broadcastRequestDelivery: (requestId) => axiosInstance.post(`/seller-requests/${requestId}/broadcast-delivery`),
    assignRequestDeliveryBoy: (requestId, deliveryBoyId) => axiosInstance.post(`/seller-requests/${requestId}/assign-delivery-boy`, { deliveryBoyId }),
